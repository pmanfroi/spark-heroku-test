import {ReactComponent as Icon} from '@/assets/importance-placeholder.svg'
...
const ImportanceLevelPlaceHolderIcon = ({size, className, ...props}: Props) => {
  // prettier-ignore
  const iconSize =
...
export default ImportanceLevelPlaceHolderIcon
